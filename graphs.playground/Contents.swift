...
let priceSingaporeToTokyo = adjacencyList.weight(from: singapore, to: tokyo)

if let flightFromSF = adjacencyList.edges(from: sanFrancisco) {
    for edge in flightFromSF {
